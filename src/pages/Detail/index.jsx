...
export default function Detail() {
  ...
  if (!item) {
    return (
      <div style={{ textAlign: 'center', padding: '100px 20px' }}>
        <h2 style={{ color: '#e74c3c', marginBottom: '20px' }}>Item not found</h2>
        <button 
          onClick={handleBackToList}
          style={{ 
            padding: '10px 20px', 
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
        ...
        <div>
          ...
          <div style={{ marginBottom: '20px' }}>
            <div style={{ 
              ...
              <span style={{ fontWeight: 'bold', color: '#666' }}>Condition:</span>
              <span style={{ 
                background: '#e8f5e8', 
                color: '#27ae60', 
                padding: '4px 8px', 
            ...
            <div style={{ 
              ...
              <span style={{ color: '#333' }}>{item.location || 'Unknown'}</span>
            </div>
            <div style={{ 
              display: 'flex', 
              justifyContent: 'space-between', 
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {item.tags && Array.isArray(item.tags) && item.tags.length > 0 ? (
                ...
                <span style={{ color: '#999', fontSize: '12px' }}>No tags available</span>
              )}
            </div>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px' }}>
        ...
        <div style={{ 
          ...
          <h3 style={{ margin: '0 0 20px 0', color: '#333', fontSize: '16px' }}>Seller Information</h3>
          {item.seller ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
              ...
              <div>
                ...
                <div style={{ color: '#f39c12', marginBottom: '5px', fontSize: '12px' }}>
            ...
            <div style={{ color: '#666', fontSize: '14px' }}>Seller information not available</div>
          )}
        </div>
