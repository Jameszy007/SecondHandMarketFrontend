    ...
    <div className="container h-100 d-flex justify-content-center align-items-center">
      <div className="card p-4 w-100">
        ...
        <div className="tab-content p-4">
          <div className={`tab-pane ${activeTab === 'favorites' ? 'active show' : ''}`}>
            <h4>Favorites</h4>
            <p>Your favorite items will be displayed here.</p>
          </div>
          <div className={`tab-pane ${activeTab === 'transactions' ? 'active show' : ''}`}>
            <h4>Transactions</h4>
            <p>Your transaction history will be displayed here.</p>
          </div>
          <div className={`tab-pane ${activeTab === 'comments' ? 'active show' : ''}`}>
            <h4>Comments</h4>
