...
export const mockItems = [
  ...
  },
  {
    ...
    description: "Latest flagship Android phone, 512GB storage, excellent condition, comes with original charger and case. Perfect for Android enthusiasts.",
    price: 850,
    originalPrice: 1199,
    category: "Electronics",
    condition: "Like New",
  ...
  },
  {
    ...
    description: "2022 iPad Pro with M2 chip, 128GB storage, Apple Pencil included, perfect for artists and professionals.",
    price: 700,
    originalPrice: 899,
    category: "Electronics",
    condition: "Good",
  ...
  },
  {
    ...
    description: "Classic canvas sneakers, size 8, white color, good condition. Perfect for casual wear and street style.",
    price: 35,
    originalPrice: 55,
    category: "Shoes",
    condition: "Good",
  ...
  },
  {
    ...
    description: "Premium running shoes, size 10.5, Made in USA, excellent condition. Perfect for daily wear and light running.",
    price: 95,
    originalPrice: 185,
    category: "Shoes",
    condition: "Like New",
  ...
  },
  {
    id: 11,
    title: "West Elm Sofa",
    description: "3-seater modern sofa, gray fabric, excellent condition, barely used. Perfect for living room or office.",
    price: 450,
    originalPrice: 899,
    category: "Furniture",
    condition: "Like New",
  ...
  },
  {
    ...
    description: "Solid oak dining table, seats 6, rustic finish, good condition. Perfect for farmhouse or traditional decor.",
    price: 280,
    originalPrice: 450,
    category: "Furniture",
    condition: "Good",
  ...
  // Clothing Category
  {
    ...
    description: "Classic straight leg jeans, size 32x32, dark wash, good condition. Perfect for everyday wear.",
    price: 25,
    originalPrice: 69,
    category: "Clothing",
    condition: "Good",
  ...
  },
  {
    ...
    description: "Waterproof winter jacket, size L, black color, excellent condition. Perfect for cold weather and outdoor activities.",
    price: 85,
    originalPrice: 199,
    category: "Clothing",
    condition: "Like New",
  ...
  // Books Category
  {
    ...
    description: "Classic novel by F. Scott Fitzgerald, hardcover edition, good condition. Perfect for literature lovers and collectors.",
    price: 8,
    originalPrice: 15,
    category: "Books",
    condition: "Good",
    ...
    tags: ["F. Scott Fitzgerald", "The Great Gatsby", "Literature", "Hardcover", "Classic"],
    views: 34,
    likes: 6
  },
  {
    ...
    description: "Technical book for developers, covers modern JavaScript, good condition. Perfect for programmers and students.",
    price: 12,
    originalPrice: 39,
    category: "Books",
    condition: "Good",
    ...
    tags: ["Programming", "JavaScript", "Technical", "Development", "Education"],
    views: 28,
    likes: 5
  },
  ...
  // Home Category
  {
    ...
    description: "Professional stand mixer, red color, excellent condition, includes attachments. Perfect for home bakers.",
    price: 180,
    originalPrice: 299,
    category: "Home",
    condition: "Like New",
  ...
  },
  {
    ...
    description: "Cordless vacuum cleaner, excellent condition, includes all attachments. Perfect for home cleaning.",
    price: 220,
    originalPrice: 399,
    category: "Home",
    condition: "Good",
  ...
  // Sports Category
  {
    ...
    description: "Professional tennis racket, excellent condition, includes case. Perfect for tennis players.",
    price: 45,
    originalPrice: 89,
    category: "Sports",
    condition: "Like New",
  ...
  },
  {
    ...
    description: "High-quality yoga mat, non-slip surface, excellent condition. Perfect for yoga and fitness.",
    price: 18,
    originalPrice: 35,
    category: "Sports",
    condition: "Good",
  ...
  // Other Category
  {
    ...
    description: "Collection of 15 classic rock vinyl records, good condition. Perfect for music collectors and enthusiasts.",
    price: 75,
    originalPrice: 120,
    category: "Other",
    condition: "Good",
  ...
  },
  {
    ...
    description: "Handcrafted coffee maker, ceramic design, excellent condition. Perfect for coffee enthusiasts.",
    price: 35,
    originalPrice: 65,
    category: "Other",
    condition: "Like New",
